...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    try {
          ...
          if (searched[0] == undefined)return sendError("Looks like i was unable to find that song , Did you make a typo?", message.channel);
                    let index = 0;
                    ...
                    return message.channel.send({
                        embed: {
                            color: "RED",
                            description: "Oops , did you make a typo with the song name?"
                        }
                    });
                }

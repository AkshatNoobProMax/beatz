...
module.exports = {
    ...
    run: async function (client, message, args) {
        ...
        if (!permissions.has("CONNECT")) return sendError("I cannot connect to your voice channel, make sure I have the permission to connect", message.channel);
        if (!permissions.has("SPEAK")) return sendError("I dont have the permission to speak in the voice channel", message.channel);
